...
public class PerfilFragment extends Fragment {
    final static String urlAddress="https://m.cooperativa.cl/noticias/site/tax/port/all/rss_3_156_1485_1.xml";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        showToolbar(getResources().getString(R.string.tab_perfil),false,view);
